...
public class AddClienteCardFragmento extends Fragment {
    ...
    public AddClienteCardFragmento() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_addcliente_cards, container, false);
    ...
    private void initLayoutComponent() {
        ...
        txtTitle.setText(R.string.titulo_add_cliente_cards);
